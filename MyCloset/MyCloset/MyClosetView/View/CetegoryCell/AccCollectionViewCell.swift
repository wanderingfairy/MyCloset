...
extension AccCollectionViewCell: MyClosetViewControllerDelegate {
        @objc func secondReloadRequestAcc() {
            print("delegateAcc")
...
extension AccCollectionViewCell: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        SelectedImageSingleton.shared.selectedImageSet.updateValue(seletedAccImage, forKey: "acc")
    }
    
    func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        SelectedImageSingleton.shared.selectedImageSet.removeValue(forKey: "acc")
    }
}
