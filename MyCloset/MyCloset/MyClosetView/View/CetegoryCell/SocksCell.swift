...
class SocksCell: UICollectionViewCell {
    ...
    extension SocksCell: MyClosetViewControllerDelegate {
        func secondReloadRequestSocks() {
            print("Socks Second delegate")
            print("결과 싱글톤",Singleton.shared.socks)
...
extension SocksCell: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        SelectedImageSingleton.shared.selectedImageSet.updateValue(seletedSocksImage, forKey: "socks")
    }
    
    func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        SelectedImageSingleton.shared.selectedImageSet.removeValue(forKey: "socks")
    }
}
